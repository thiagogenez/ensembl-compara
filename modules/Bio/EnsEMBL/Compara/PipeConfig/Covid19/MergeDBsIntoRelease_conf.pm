...
Bio::EnsEMBL::Compara::PipeConfig::Covid19::MergeDBsIntoRelease_conf

=head1 SYNOPSIS

    #1. initialize the pipeline:
        init_pipeline.pl Bio::EnsEMBL::Compara::PipeConfig::Covid19::MergeDBsIntoRelease_conf -host mysql-ens-compara-prod-X -port XXXX

=head1 DESCRIPTION

A Covid19 specific pipeline to merge some production databases onto the release one.

The default parameters work well in the context of a Compara release for Covid19 (with a well-configured
...
package Bio::EnsEMBL::Compara::PipeConfig::Covid19::MergeDBsIntoRelease_conf;
